...
return(
  <div className="min-h-screen flex flex-col items-center justify-center bg-yellow-100 p-4 border-8 border-purple-400 rounded-3xl shadow-2xl">
    <h1 className="text-3xl sm:text-4xl font-extrabold text-purple-700 mb-6 text-center">🎯 Number Game</h1>
    ...
    <div className="grid grid-cols-5 gap-2 sm:gap-4 mb-4 w-full max-w-xs">
      ...
      className="col-span-3 bg-red-400 text-white font-bold py-4 sm:py-5 rounded-lg shadow-lg hover:bg-red-500 transition transform hover:scale-105 text-lg sm:text-xl"
      >Clear</button>
